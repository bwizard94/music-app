...
const footerLinks = {
  Platform: ['Discover Artists', 'Find Venues', 'Browse Events', 'Local Scenes', 'Collaboration Hub'],
  'For Artists': ['Create Profile', 'Set Availability', 'Accept Bookings', 'Artist Resources', 'Artist Blog'],
  'For Venues': ['List Your Venue', 'Find Talent', 'Booking Management', 'Venue Analytics', 'Success Stories'],
  Company: ['About Stagefront', 'Careers', 'Press Kit', 'Contact', 'Privacy Policy'],
};
